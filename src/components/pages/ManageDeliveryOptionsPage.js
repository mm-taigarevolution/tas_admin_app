...
class ManageDeliveryOptionsPage extends React.Component {
...
//
ManageDeliveryOptionsPage.propTypes = {
...
//
ManageDeliveryOptionsPage.contextTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ManageDeliveryOptionsPage);
