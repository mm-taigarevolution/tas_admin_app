...
class ManageItemLocationsPage extends React.Component {
...
//
ManageItemLocationsPage.propTypes = {
...
//
ManageItemLocationsPage.contextTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ManageItemLocationsPage);
