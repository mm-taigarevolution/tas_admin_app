...
class ManagePaymentOptionsPage extends React.Component {
...
//
ManagePaymentOptionsPage.propTypes = {
...
//
ManagePaymentOptionsPage.contextTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ManagePaymentOptionsPage);
